...
/*=========================================================================
 ...
 Thing
 Console-Fenster fÅr Single-TOS
 =========================================================================*/
...
/*-------------------------------------------------------------------------
 ...
 Routinen fÅr das Console-Fenster (Redraw etc.)
 -------------------------------------------------------------------------*/
/**
 *
 */
...
/*-------------------------------------------------------------------------
 ...
 Setzen des Fonts und Berechnen der Fenstergrîûe
 -------------------------------------------------------------------------*/
/**
 *
 */
void cwin_attr(void) {
	...
	/* Fenstergrîûe an die ermittelten Werte anpassen */
	w = columns * con.cw;
	h = lines * con.ch;
	...
	/* Neue Grîûe setzen und Slider aktualisieren */
...
/*-------------------------------------------------------------------------
 ...
 Console-Fenster îffnen. Das Fenster wird immer so geîffnet, dass es
 vollstÑndig sichtbar ist. Ist es bereits offen, wird es nur in den
 Vordergrund geholt
 -------------------------------------------------------------------------*/
/**
 *
...
short cwin_open(void) {
	...
	/* TOS2GEM vorhanden? */
	if (Getcookie(C_T2GM /*'T2GM'*/, (long *) &con.tos2gem) != E_OK)
		return (-1);
	if (!con.tos2gem)
		return (-1);
